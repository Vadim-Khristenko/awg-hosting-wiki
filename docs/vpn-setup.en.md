...
### 1️⃣ Step 1. Purchase a Virtual Private Server (VPS)
...
!!! failure "Attention: Incompatible Hostings"
...
### 2️⃣ Step 2. Get Access Credentials
...
### 3️⃣ Step 3. Installation and Launch via AmneziaVPN
